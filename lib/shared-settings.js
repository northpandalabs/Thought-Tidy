...
function initExportImportSection(s) {
  ...
  importLogWrap.style.cssText = "margin-bottom:8px";
  ...
  importLogEl.style.cssText = "display:none;font-size:11px;font-family:monospace;display:none;flex-direction:column;gap:4px;max-height:160px;overflow-y:auto;padding:8px;background:var(--bg3,#11111b);border-radius:4px";
  ...
  // Auto-expand log in test/debug builds
